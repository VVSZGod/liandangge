...
import com.jiamian.translation.common.exception.*;
...
public class LoggerUtil {
	...
	public static void error(String msg, Exception e) {
		if (isNeedEmail(e)) {
			String exceptionContent = getExceptionContent(msg, e);
			ThreadUtil.getExecutorPool().submit(() -> PushUtil
					.warn(projectName + "错误告警", exceptionContent));
		}
		if (isShow(e)) {
			initLineNumber();
	...
	public static String getExceptionContent(Object object, Exception e) {
		StringBuilder sb = new StringBuilder();
		try {
			if (ServletUtil.getNullableRequest() != null) {
				sb.append(getRequestMsg(ServletUtil.getRequest()))
						.append("<br><br>");
			}
			sb.append(parseContent(object));
			sb.append("<br><br>").append(e);
		} catch (Exception e1) {
			logger.error("getExceptionContent fail", e1);
		}
		return sb.toString();
	}
