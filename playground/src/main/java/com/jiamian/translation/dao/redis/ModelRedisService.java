...
public class ModelRedisService {
    ...
    public void setModelUploadCount(int count) {
        redisTemplate.opsForValue().set(RedisCacheKey.MODEL_TOTAL_UPLOADED_COUNT_PREFIX, count);
        redisTemplate.expire(RedisCacheKey.MODEL_TOTAL_UPLOADED_COUNT_PREFIX, 1, TimeUnit.HOURS);
    }
    ...
    public void setModelTotalCount(int count) {
        redisTemplate.opsForValue().set(RedisCacheKey.MODEL_TOTAL_COUNT_PREFIX, count);
        redisTemplate.expire(RedisCacheKey.MODEL_TOTAL_COUNT_PREFIX, 1, TimeUnit.HOURS);
    }
    ...
    public void setModelType(String value) {
        ...
        redisTemplate.expire(RedisCacheKey.MODEL_TOTAL_UPLOADED_COUNT_PREFIX, 7, TimeUnit.DAYS);
    }

    public String getModelType() {
        Object o = redisTemplate.opsForValue().get(RedisCacheKey.MODEL_TYPE_PREFIX);
